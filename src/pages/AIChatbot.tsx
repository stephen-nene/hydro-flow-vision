        ...
        <main className="flex-1 p-6">
          <Breadcrumb className="mb-6">
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/ai-chatbot">AI Chatbot</BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          ...
          <header>
            ...
            <p className={`text-lg ${isEmergencyMode ? 'text-gray-300' : 'text-gray-600'}`}>
              Get assistance and insights from the Hydro-Flow AI assistant
            </p>
          </header>

          <div className="mt-8 glass-card p-6 rounded-xl">
            <div className="text-center py-12">
              <h2 className="text-xl font-medium mb-2">Hydro Assistant</h2>
              <p className="text-gray-500">
                Connect to the NLP pipeline to enable AI-powered water quality analysis
              </p>
            </div>
          </div>
        </main>
